...
public class BD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE CONYUGUE(IDCONYUGUE INTEGER PRIMARY KEY AUTOINCREMENT, NOMBRE VARCHAR(400),FOREGEIN KEY (IDTRABAJADOR) REFERENCES TRABAJADOR (IDTRABAJADOR))");//EJECUTA SQL
